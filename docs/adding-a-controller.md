...
```sh
codex-midi midi list
codex-midi midi monitor --input "Exact Input Port"
```
...
mappings, encoder timing, firmware, battery, vendor mode, or lighting.
...
The bundled ATOM is the exception: as the reference adapter, it retains a
comprehensive black-box regression through public controller construction.
